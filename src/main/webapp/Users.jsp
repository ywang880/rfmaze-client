...
<table class="ConfigDataTable" width="80%" align="center" style="border-collapse:collapse;">
   ...
   <table align="center" id="_user_data" style="display: none;">
	  <tr>
    	 <td align="right" nowrap>Name:&nbsp;</td><td align="left"><s:textfield name="id" key="label.username" size="20"/></td>
	  </tr>
	  <tr>
    	 <td align="right" nowrap>Password:&nbsp;</td>
         <td align="left">
             <s:password id="user_passwd" name="password" key="label.password" size="20"/>
