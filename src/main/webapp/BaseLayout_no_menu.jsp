...
<link rel="stylesheet" href="css/style.css?version=1.0.0" type="text/css" media="screen, projection"/>
...
<body style="margin-bottom:50px;" background="images/rfmaze_background.png?1.0.0.0-1000">
    <table id="maintable">
        <tr>
