...
function changeAttn(a) {
    ...
    $("#attenuation").val(a.innerHTML), $("#slider").slider("value", a.innerHTML), 
    ...
    $("#id_inputs").val(a.parentNode.rowIndex+1),
    $("#id_inputs").disabled = !0,
    $("#mimo").disabled = !0, $("#inputs_label").text("Route Number"), 
    $("#mimo").attr("checked", !1), 
    $("#mimo1").attr("checked", !1);
}

function changeAttn2(a) {
    $("#attenuation1").val(a.innerHTML), $("#slider1").slider("value", a.innerHTML), 
    ...
    $("#id_inputs1").val(a.parentNode.rowIndex+1), 
    $("#id_inputs1").disabled = !0,
    $("#mimo1").disabled = !0, $("#inputs_label1").text("Route Number"), 
    $("#mimo").attr("checked", !1), 
    $("#mimo1").attr("checked", !1);
}
...
function set_attenuation_btn(a) {
    if (1 == a) {
        var b = document.getElementById("attenuation").value, c = document.getElementById("id_inputs").value;
        $("#slider").slider("value", b), set_attenuation(c, d, b);
    } else if (2 == a) {
        var b = document.getElementById("attenuation1").value, c = document.getElementById("id_inputs1").value,
...
function set_atten(a, b) {
    if (1 == a) {
        ...
        var c = document.getElementById("id_inputs").value;
        $("#slider").slider("value", b), set_attenuation(c, d, b);
    } else if (2 == a) {
        document.getElementById("attenuation1").value = b;
        var c = document.getElementById("id_inputs1").value;
        $("#slider1").slider("value", b), set_attenuation(c, d, b);
    }
}
...
function increment_and_send(a) {
    if (!in_progress1) if (in_progress1 = !0, setTimeout(function() {
        ...
        var b = document.getElementById("id_inputs").value, d = document.getElementById("attenuation").value;
        ...
        var b = document.getElementById("id_inputs1").value, d = document.getElementById("attenuation1").value;
        if (120 == d) return void alert("The new value exceeds the limit. Maximum value is 120");
        var e = ++d;
