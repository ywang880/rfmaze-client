...
<table border="0" cellspacing="0" cellpadding="0" width="100%" background="images/banner_bg.png">
    ...
    <tr>
        <td align="right" colspan="2"><div class="greynavbar"><img src="images/spacer.gif" width="1" height="10"/></div></td>
    </tr>
</table>
       ...
       <tr>
          <td align="center">
             <p style="font-family: Helvetica; color:#002233; font-size:16px;">
               RFMaze is the software tool used to control the RF attenuation or switch matrix.
             </p>
             <p style="font-family: Helvetica; color:#002233; font-size:16px;">
               To use the RFMaze you need to provision users and configure the system. <br/>
               To manage the RFMaze configuration, user profiles and allocate resources to users, login as admin. <br/>
               To use the RFMaze, login as a regular user, for example, "chamber1".
               Click on help icon to get online help.
             </p>
          </td>
       </tr>
       <tr><td><img src="images/spacer.gif" width="1" height="30"/></td><tr>
    </table>
    ...
    <div id="footer">
        <table style="background-image: url(images/footer_bg.png); width: 100%; height:35px">
            <tr>
                <td style="text-align: center; vertical-align: middle; font-size:12px;">Copyright &copy;Acentury Inc. 2014-2017</td>
            </tr>
        </table>
    </div>
</body>
